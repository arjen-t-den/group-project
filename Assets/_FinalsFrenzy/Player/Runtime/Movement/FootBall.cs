...
namespace Group8.FinalsFrenzy.Player
{
    ...
    public class FootBall : MonoBehaviour
    {
        ...
        /// <summary>
        /// Sets the foot ball's angular velocity to match the target linear velocity.
        /// </summary>
        /// <param name="targetLinearVelocity">The target linear velocity of the foot ball.</param>
